...
module krome_commons
  ...
  !  KROME 14.08.dev on 2022-02-04 14:14:39
  !  Changeset 2741b60
  ...
  integer,parameter::idx_kphHI=14
  integer,parameter::idx_kphHeI=15
  integer,parameter::idx_kphHeII=16
  integer,parameter::idx_kdissH2I=17
  integer,parameter::idx_photogamma=18
...
contains
  ...
  ! *************************************************************
  !  This file has been generated with:
  !  KROME 14.08.dev on 2022-02-04 14:14:40
  !  Changeset 2741b60
  !  see http://kromepackage.org
  !
  !  Written and developed by Tommaso Grassi and Stefano Bovino
...
contains
  ...
  function coe(n)
    ...
    !H2 -> H + H
    k(31) = 9.d-13*user_J21*krome_fshield(n,Tgas)
  ...
  subroutine load_arrays()
    ...
    arr_r1(1:31) = (/3,6,6,4,7,7,7,9,3,2,3,3,8,5,5,5,5,2,2,2,2,2&
        ,8,8,3,5,5,7,4,4,5/)
    arr_r2(1:31) = (/1,1,1,1,1,1,1,1,1,3&
        ,6,6,3,6,1,1,3,1,3,3,6,6,1,2,3,3,5,3,6,6&
        ,13/)
    arr_r3(1:31) = (/13,13,13,13,13,13,13,13,13,13,13,13&
        ,13,13,13,13,13,13,13,13,13,13,13,13,3,3,13,13,13,13&
        ,13/)
    arr_p1(1:31) = (/6,3,3,7,4,4,9,7,2,5,8,8,5,8,3,3,3,3&
        ,3,3,3,8,3,3,5,5,3,4,7,7,3/)
    arr_p2(1:31) = (/1,13,13,1,13&
        ,13,1,13,13,1,13,13,6,3,2,3,3,1,3,3,3,1,3,5,3,5,3,6,3,3&
        ,3/)
    arr_p3(1:31) = (/1,13,13,1,13,13,1,13,13,13,13,13,13&
        ,13,13,1,3,1,1,1,13,13,13,13,13,13,5,13,13,13,13/)
...
contains
  ...
  function coe_tab(n)
    ...
    !non tabulated rates
    !H2 + H -> H + H + H
    coe_tab(17) = small + (dissH2_Martin96(n,Tgas))
...
module krome_user
  ...
  integer,parameter::KROME_idx_kphHj = 14 !Radiative field for H+
  integer,parameter::KROME_idx_kphHej = 15 !Radiative field for He+
  integer,parameter::KROME_idx_kphHejj = 16 !Radiative field for He++
  integer,parameter::KROME_idx_kdissH2j = 17 !Radiative dissociation for H2+
  integer,parameter::KROME_idx_photogamma = 18 !photonfield (?)
  ...
  integer,parameter::krome_nrea=31
...
contains
  ...
  !*******************
  subroutine krome_set_user_J21(argset)
    use krome_commons
    implicit none
    real*8 :: argset
    user_J21 = argset
  end subroutine krome_set_user_J21

  !*******************
  function krome_get_user_J21()
    use krome_commons
    implicit none
    real*8 :: krome_get_user_J21
    krome_get_user_J21 = user_J21
  end function krome_get_user_J21
